...
import { Sun, Cloud, Wind, Waves, Plane, MapPin, Camera, Compass, Palmtree, UtensilsCrossed, Music } from 'lucide-react';

const Hero = ()=> {
  const [preferredActivity, setPreferredActivity] = useState('relaxation');
  ...
  const beachActivities = [
    ...
    { 
      ...
      description: 'Party by the shore', 
      color: 'from-purple-500 to-pink-500' 
    }
  ];

  const getActivityLabel = (activityId) => {
    const activity = beachActivities.find(act => act.id === activityId);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up-delayed-2">
              Discover perfect coastal destinations tailored to your beach style. From thrilling water sports to serene sunset lounging, find your ideal beach getaway.
            </p>
          </div>

          {/* Beach Activity Preference Selector */}
          <div className="max-w-5xl mx-auto mb-8">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">What's your beach vibe?</h3>
              <p className="text-gray-600">Choose your perfect beach experience to discover tailored destinations</p>
            </div>
                  ...
                  <div className="relative flex flex-col items-center space-y-3">
                    ...
                    <div className="text-center">
                      <span className={`font-semibold text-sm block mb-1 ${
                        preferredActivity === activity.id ? 'text-blue-700' : 'text-gray-700'
                      }`}>
                        {activity.label}
                      </span>
                      <span className={`text-xs ${
                        preferredActivity === activity.id ? 'text-blue-600' : 'text-gray-500'
                      }`}>
          ...
          <div className="text-center animate-fade-in-up-delayed-3">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-blue-200 shadow-lg">
              ...
              <span className="text-blue-700 font-medium">Discover your perfect beach destination below</span>
        ...
        <div className="text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-200">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Your Beach Adventure Starts Here
            </h2>
            <p className="text-gray-600 mb-6">
              Based on your preference for <span className="font-semibold text-blue-600">
                {getActivityLabel(preferredActivity)}
              </span>, we'll help you discover the perfect coastal destinations tailored just for you.
            </p>
